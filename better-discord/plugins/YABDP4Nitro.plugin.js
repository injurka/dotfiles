          ...
          return class YABDP4Nitro extends Plugin {
              ...
              return Settings.SettingPanel.build(
                ...
                ...[
                  new Settings.SettingGroup("Screen Share Features").append(
                    ...[
                      new Settings.Switch(
                        ...
                        "1080p/Source @ 60fps screensharing. Enable if you want to use any Screen Share related options.",
                      ...
                      new Settings.Switch(
                        "Stream Settings Quick Swapper",
                        "Adds a button that will let you switch your resolution quickly!",
                        this.settings.ResolutionSwapper,
                        (value) => (this.settings.ResolutionSwapper = value)
                      ),
                      new Settings.Switch(
                        "Custom Bitrate",
                        "Choose the bitrate for your streams!",
                        this.settings.CustomBitrateEnabled,
                        (value) => (this.settings.CustomBitrateEnabled = value)
                      ),
                      new Settings.Textbox(
                        "Minimum Bitrate",
                        "The minimum bitrate (in kbps).",
                        this.settings.minBitrate,
                        (value) => {
                      ...
                      new Settings.Textbox(
                        "Target Bitrate",
                        "The target bitrate (in kbps).",
                        this.settings.targetBitrate,
                        (value) => {
                          value = parseFloat(value);
                      ...
                      new Settings.Textbox(
                        "Voice Audio Bitrate",
                        "Allows you to change the voice bitrate to whatever you want. Does not allow you to go over the voice channel's set bitrate but it does allow you to go much lower. (bitrate in kbps).",
                        this.settings.voiceBitrate,
                        (value) => {
                          value = parseFloat(value);
                      ...
                      new Settings.Dropdown(
                        ...
                        "Changes the screen share video codec to the one set.",
                        ...
                        (value) => (this.settings.videoCodec = value),
                        { searchable: true }
                      ),
                    ]
                  ),
                  new Settings.SettingGroup("Emojis").append(
                    ...
                    new Settings.Dropdown(
                      "Size",
                      "The size of the emoji in pixels.",
                      this.settings.emojiSize,
                      [
                        { label: "32px (Default small/inline)", value: 32 },
                        {
                          label: "48px (Recommended, default large)",
                          value: 48,
                        },
                        { label: "16px", value: 16 },
                        { label: "24px", value: 24 },
                    ...
                    new Settings.Switch(
                      "Ghost Mode",
                      "Abuses ghost message bug to hide the emoji url.",
                    ...
                    new Settings.Switch(
                      ...
                      "Upload emotes as image(s) after message is sent. (Overrides linking emotes)",
                      this.settings.uploadEmotes,
                      (value) => (this.settings.uploadEmotes = value)
                    ),
                    new Settings.Switch(
                      "Sticker Bypass",
                      "Enable or disable using the sticker bypass. I recommend using An00nymushun's DiscordFreeStickers over this. Animated APNG/WEBP/Lottie Stickers will not animate.",
                      this.settings.stickerBypass,
                      (value) => (this.settings.stickerBypass = value)
                    ),
                    new Settings.Switch(
                      "Upload Stickers",
                      "Upload stickers in the same way as emotes.",
                      this.settings.uploadStickers,
                      (value) => (this.settings.uploadStickers = value)
                    ),
                    new Settings.Switch(
                      "Force Stickers Unlocked",
                      "Enable to cause Stickers to be unlocked.",
                      this.settings.forceStickersUnlocked,
                      (value) => (this.settings.forceStickersUnlocked = value)
                    )
                  ),
                  new Settings.SettingGroup("Profile").append(
                    new Settings.Switch(
                      "Profile Accents",
                      "When enabled, you will see (almost) all users with the new Nitro-exclusive look for profiles (the sexier look). When disabled, the default behavior is used. Does not allow you to update your profile accent.",
                      this.settings.profileV2,
                      (value) => (this.settings.profileV2 = value)
                    ),
                    new Settings.Switch(
                      "Fake Profile Themes",
                      "Uses invisible 3y3 encoding to allow profile theming by hiding the colors in your bio.",
                      this.settings.fakeProfileThemes,
                      (value) => (this.settings.fakeProfileThemes = value)
                    ),
                    new Settings.Switch(
                      "Fake Profile Banners",
                      "Uses invisible 3y3 encoding to allow setting profile banners by hiding the image URL in your bio. Only supports Imgur URLs for security reasons.",
                      this.settings.fakeProfileBanners,
                      (value) => (this.settings.fakeProfileBanners = value)
                    ),
                    new Settings.Switch(
                      "UserBG Integration",
                      "Downloads and parses the UserBG JSON database so that UserBG banners will appear for you.",
                      this.settings.userBgIntegration,
                      (value) => (this.settings.userBgIntegration = value)
                    ),
                    new Settings.Switch(
                      "Fake Avatar Decorations",
                      "Uses invisible 3y3 encoding to allow setting avatar decorations by hiding information in your bio and/or your custom status.",
                      this.settings.fakeAvatarDecorations,
                      (value) => (this.settings.fakeAvatarDecorations = value)
                    ),
                    new Settings.Switch(
                      "Fake Profile Effects",
                      "Uses invisible 3y3 encoding to allow setting profile effects by hiding information in your bio.",
                      this.settings.profileEffects,
                      (value) => (this.settings.profileEffects = value)
                    ),
                    new Settings.Switch(
                      "Kill Profile Effects",
                      "Hate profile effects? Enable this and they'll be gone. All of them. Overrides all profile effects.",
                      this.settings.killProfileEffects,
                      (value) => (this.settings.killProfileEffects = value)
                    ),
                    new Settings.Switch(
                      "Fake Profile Pictures",
                      "Uses invisible 3y3 encoding to allow setting custom profile pictures by hiding an image URL IN YOUR CUSTOM STATUS. Only supports Imgur URLs for security reasons.",
                      this.settings.customPFPs,
                      (value) => (this.settings.customPFPs = value)
                    ),
                    new Settings.Switch(
                      "UserPFP Integration",
                      "Imports the UserPFP database so that people who have profile pictures in the UserPFP database will appear with their UserPFP profile picture. There's little reason to disable this.",
                      this.settings.userPfpIntegration,
                      (value) => (this.settings.userPfpIntegration = value)
                    )
                  ),
                  new Settings.SettingGroup("Miscellaneous").append(
                    new Settings.Switch(
                      "Change PremiumType",
                      "This is now optional. Enabling this may help compatibility for certain things or harm it. SimpleDiscordCrypt requires this to be enabled to have the emoji bypass work. Only enable this if you don't have Nitro.",
                      this.settings.changePremiumType,
                      (value) => (this.settings.changePremiumType = value)
                    ),
                    new Settings.Switch(
                      "Gradient Client Themes",
                      "Allows you to use Nitro-exclusive Client Themes.",
                      this.settings.clientThemes,
                      (value) => (this.settings.clientThemes = value)
                    ),
                    ...
                    new Settings.Switch(
                      "Remove Screen Share Nitro Upsell",
                      "Removes the Nitro upsell in the Screen Share quality option menu.",
                      this.settings.removeScreenshareUpsell,
                      (value) => (this.settings.removeScreenshareUpsell = value)
                    ),
                    new Settings.Switch(
                      "App Icons",
                      'Unlocks app icons. Warning: enabling this will force "Change Premium Type" to be enabled. Buggy.',
                      this.settings.unlockAppIcons,
                      (value) => (this.settings.unlockAppIcons = value)
                    ),
                    new Settings.Switch(
                      "Experiments",
                      "Unlocks experiments. Use at your own risk.",
                      this.settings.experiments,
                      (value) => (this.settings.experiments = value)
                    )
                  ),
                ]
              );
            ...
            saveAndUpdate() {
              ...
              if (this.settings.changePremiumType) {
                try {
                  ...
                  console.log(
                    "[YABDP4Nitro]: Error occurred changing premium type."
                  );
                  console.error(err);
                }
              }
              ...
              if (document.getElementById("qualityButton"))
                document.getElementById("qualityButton").remove();
              if (document.getElementById("qualityMenu"))
                document.getElementById("qualityMenu").remove();
              if (document.getElementById("qualityInput"))
                document.getElementById("qualityInput").remove();
              ...
              if (this.settings.ResolutionSwapper) {
                ...
                try {
                  document
                    ...
                    .addEventListener("input", this.updateQuick);
                  document
                    .getElementById("qualityInputFPS")
                    .addEventListener("input", this.updateQuick);
                  if (!this.settings.ResolutionSwapper) {
                    if (document.getElementById("qualityButton") != undefined)
                      document.getElementById("qualityButton").style.display =
                        "none";
                    if (document.getElementById("qualityMenu") != undefined)
                      document.getElementById("qualityMenu").style.display =
                        "none";
                  }
                } catch (err) {
                  console.error(err);
              ...
              if (this.settings.emojiBypass) {
                try {
                  ...
                  if (this.emojiMods == undefined)
                    this.emojiMods = WebpackModules.getByProps(
              ...
              if (this.settings.screenSharing) {
                try {
                  ...
                  console.log(
                    "[YABDP4Nitro]: Error occurred during customVideoSettings;()"
                  );
                  console.error(err);
                }
                try {
                  ...
                  console.log(
                    "[YABDP4Nitro]: Error occurred during videoQualityModule();"
                  );
                  console.error(err);
                }
              }
              ...
              if (this.settings.forceStickersUnlocked) {
                if (this.stickerSendabilityModule == undefined)
                  this.stickerSendabilityModule =
                    WebpackModules.getByProps("isSendableSticker");
              ...
              if (this.settings.fakeProfileThemes) {
                try {
                  ...
                  console.log(
                    "[YABDP4Nitro]: Error occurred running fakeProfileThemes bypass."
                  );
                  console.error(err);
                }
              }
              ...
              if (
                this.hasAddedScreenshareUpsellStyle &&
                !this.settings.removeScreenshareUpsell
              ) {
                try {
              ...
              if (this.settings.fakeProfileBanners) {
                try {
                  ...
                  console.log(
                    "[YABDP4Nitro]: What the fuck happened? fakeProfileBanners"
                  );
                  console.error(err);
                }
              }
              ...
              if (this.settings.fakeAvatarDecorations) {
                try {
                  ...
                  console.log(
                    "[YABDP4Nitro]: An error occurred during fakeAvatarDecorations();"
                  );
                  console.error(err);
                }
              }
              ...
              if (this.settings.killProfileEffects) {
                try {
                  ...
                  console.log(
                    "[YABDP4Nitro]: Error occured during killProfileFX();"
                  );
                  console.error(err);
                }
              }
              ...
              try {
                ...
                console.log(
                  "[YABDP4Nitro] An error occurred during honorBadge();"
                );
                console.error(err);
              }
              ...
              if (this.settings.customPFPs) {
                try {
                  ...
                  this.customProfilePictureEncoding(
                    this.secondsightifyEncodeOnly
                  );
                } catch (err) {
                  console.log(
                    "[YABDP4Nitro] An error occurred during customProfilePicture decoding/encoding."
                  );
                  console.error(err);
                }
              }
              ...
              if (
                ...
                //account panel breaking shit workaround
                if (this.accountPanelRenderer == undefined)
                  this.accountPanelRenderer = WebpackModules.getAllByProps(
                    "default"
                  ).filter((obj) =>
                    obj.default.toString().includes("useIsHomeSelected")
                  )[0];

                BdApi.Patcher.after(
                  "YABDP4Nitro",
                  this.accountPanelRenderer,
                  "default",
                  (_, args, ret) => {
                    if (
                      this.settings.unlockAppIcons ||
                      ...
                      ret.props.currentUser.premiumType = 1;
                    if (this.settings.experiments)
                      ret.props.currentUser.flags |= 1;
                    if (
                      this.settings.ResolutionSwapper &&
                      (document.getElementById("qualityButton") == undefined ||
                        document.getElementById("qualityInputFPS") == undefined)
                    ) {
                      this.buttonCreate();
                      document
                        .getElementById("qualityInput")
            ...
            experiments() {
              ...
              try {
                ...
                let UserStore = Object.values(cache).find(
                  (m) => m?.exports?.default?.getUser
                ).exports.default;
            ...
            clientThemes() {
              if (this.clientThemesModule == undefined)
                this.clientThemesModule = BdApi.Webpack.getModule(
                  BdApi.Webpack.Filters.byProps("isPreview")
                );
              ...
              if (this.themesModule == undefined)
                this.themesModule =
                  WebpackModules.getByProps("saveClientTheme");

              if (this.gradientSettingModule == undefined)
                this.gradientSettingModule = WebpackModules.getByProps(
              ...
              BdApi.Patcher.instead(
                ...
                (_, args) => {
                  if (args[0].backgroundGradientPresetId == undefined) {
                          ...
                          settings: {
                            ...
                            clientThemeSettings: {
                              backgroundGradientPresetId:
                                args[0].backgroundGradientPresetId, //preset ID for the gradient theme
                            },
                            developerMode: true,
                          },
                        },
                    ...
                    this.gradientSettingModule.updateBackgroundGradientPreset(
                      this.settings.lastGradientSettingStore
                    );
                  }
                }
              ...
              if (this.accountSwitchModule == undefined)
                this.accountSwitchModule =
                  WebpackModules.getByProps("startSession");
            ...
            customProfilePictureDecoding() {
              if (this.getAvatarUrlModule == undefined)
                this.getAvatarUrlModule =
                  WebpackModules.getByPrototypes("getAvatarURL").prototype;

              BdApi.Patcher.instead(
                "YABDP4Nitro",
                this.getAvatarUrlModule,
                "getAvatarURL",
                (user, [userId, size, shouldAnimate], originalFunction) => {
                  //userpfp closer integration
                  //if we haven't fetched userPFP database yet and it's enabled
                  if (
                    (!this.fetchedUserPfp || this.userPfps == undefined) &&
                    this.settings.userPfpIntegration
                  ) {
                    const userPfpJsonUrl =
                  ...
                  if (
                    DiscordModules.UserStatusStore.getActivities(user.id)
                      .length > 0
                  ) {
                    //get user activities
                    let activities =
                    ...
                    if (customStatus == undefined)
                      return originalFunction(userId, size, shouldAnimate);
                    //decode any 3y3 text
                    let revealedText = this.secondsightifyRevealOnly(
                      String(customStatus)
                    );
                    ...
                    if (
                      !String(matchedText).endsWith(".gif") &&
                      !String(matchedText).endsWith(".png") &&
                      !String(matchedText).endsWith(".jpg") &&
                      !String(matchedText).endsWith(".jpeg") &&
                      !String(matchedText).endsWith(".webp")
                    ) {
                    ...
                    if (!this.badgeUserIDs.includes(user.id))
                      this.badgeUserIDs.push(user.id);
            ...
            async customProfilePictureEncoding(secondsightifyEncodeOnly) {
              ...
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byStrings("USER_SETTINGS_RESET_AVATAR")
              );
              //store avatar customization section renderer module
              if (this.customPFPSettingsRenderMod == undefined)
                this.customPFPSettingsRenderMod = WebpackModules.getAllByProps(
                  "default"
                ).filter((obj) =>
                  obj.default.toString().includes("USER_SETTINGS_RESET_AVATAR")
                )[0];

              BdApi.Patcher.after(
                "YABDP4Nitro",
                this.customPFPSettingsRenderMod,
                "default",
                (_, [args], ret) => {
                  ...
                  ret.props.children.props.children.push(
                    BdApi.React.createElement("button", {
                      ...
                      onClick: async function () {
                        ...
                        let profilePictureUrlInputValue = String(
                          document.getElementById("profilePictureUrlInput")
                            .value
                        );
                        ...
                        if (
                          stringToEncode.toLowerCase().startsWith("imgur.com")
                        ) {
                          ...
                          if (
                            ...
                            stringToEncode = await BdApi.Net.fetch(
                              "https://" + stringToEncode,
                              {
                                method: "GET",
                                mode: "cors",
                              }
                          ...
                          stringToEncode =
                            "P{" +
                            stringToEncode.replace("imgur.com/", "") +
                            "}";
                          //finally encode the string, adding a space before it so nothing fucks up
                          encodedStr =
                            " " + secondsightifyEncodeOnly(stringToEncode);
                        ...
                        const clipboardTextElem =
                          document.createElement("textarea"); //create a textarea
              ...
              BdApi.Patcher.after(
                ...
                (_, args, ret) => {
                  ...
                  for (let i = 0; i < ret.badges.length; i++) {
                    //for each of currently processed user's badges
                  ...
                  if (
                    this.badgeUserIDs.includes(ret.userId) &&
                    !badgesList.includes("yabdp_user")
                  ) {
                  ...
                  if (
                    ret.userId == "359063827091816448" &&
                    !badgesList.includes("yabdp_creator")
                  ) {
                  ...
                  if (
                    specialThanks.includes(ret.userId) &&
                    !badgesList.includes("yabdp_contributor")
                  ) {
            ...
            async profileFX(secondsightifyEncodeOnly) {
              ...
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byProps("profileEffects", "tryItOutId")
              );

              //try to get profile effects data
              if (this.profileEffects == undefined)
                this.profileEffects = WebpackModules.getByProps(
                  "profileEffects",
                  "tryItOutId"
                ).profileEffects;
              ...
              if (this.profileEffects == undefined) {
                ...
                await WebpackModules.getByProps("fetchUserProfileEffects")
                  .fetchUserProfileEffects()
                  .then(() => {
              ...
              BdApi.Patcher.after(
                ...
                (_, args, ret) => {
                  ...
                  if (revealedText.includes("/fx")) {
                    ...
                    let effectIndex = parseInt(
                      revealedText.slice(position + 3, position + 5)
                    );
                    //ignore invalid data
                    ...
                    if (!this.badgeUserIDs.includes(args[0]))
                      this.badgeUserIDs.push(args[0]);
                  }
                }
              ); //end of getUserProfile patch.

              //override 2023-08_profile_effects experiment to forcibly enable profile effects.
              if (this.experimentsModule == undefined)
                this.experimentsModule = WebpackModules.getByProps(
                  "getExperimentOverrides"
                );
              if (
                this.experimentsModule.getExperimentOverrides()[
                  "2023-08_profile_effects"
                ] == undefined
              ) {
                this.dispatcher.dispatch({
              ...
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byStrings("openProfileEffectModal")
              );

              //fetch the module now that it's loaded
              if (this.profileEffectSectionRenderer == undefined)
                this.profileEffectSectionRenderer =
                  WebpackModules.getAllByProps("default").filter((obj) =>
                    obj.default.toString().includes("openProfileEffectModal")
                  )[0];
              ...
              BdApi.Patcher.after(
                ...
                (_, [args], ret) => {
                  ...
                  for (let i = 0; i < this.profileEffects.length; i++) {
                    ...
                    let previewURL =
                      this.profileEffects[i].config.thumbnailPreviewSrc;
                    ...
                    BdApi.React.createElement("button", {
                      ...
                      onClick: () => {
                        BdApi.showConfirmationModal(
                          "Change Profile Effect (YABDP4Nitro)",
                          BdApi.React.createElement(EffectsModal)
                        );
                      },
                    })
                  );
            ...
            async fakeAvatarDecorations(self) {
                ...
                (_, args, ret) => {
                  ...
                  function getRevealedText(self) {
                    ...
                    if (self.downloadedUserProfiles.includes(args[0])) {
                      ...
                      let userProfile = self.userProfileMod.getUserProfile(
                        args[0]
                      );
                      ...
                      if (userProfile.bio != undefined) {
                        ...
                        revealedTextLocal = self.secondsightifyRevealOnly(
                    ...
                    if (
                      DiscordModules.UserStatusStore.getActivities(args[0])
                        .length > 0
                    ) {
                  ...
                  if (
                    ret.avatarDecorationData == undefined ||
                    ret.avatarDecorationData?.asset !=
                      avatarDecorations[assetId]
                  ) {
                    ...
                    if (!this.badgeUserIDs.includes(ret.id))
                      this.badgeUserIDs.push(ret.id);
                  }
                }
              ...
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byProps("default", "useFetchPurchases")
              );
              ...
              products.forEach((product) => {
                product.items.forEach((item) => {
                  if (item.asset != undefined) {
                    Object.assign(self.settings.avatarDecorations)[item.id] =
                      item.asset;
                  }
                });
              });
              ...
              WebpackModules.getByProps(
                "fetchCollectiblesCategories"
              ).fetchCollectiblesCategories();

              //Wait for avatar decor customization section render module to be loaded.
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byStrings(
                  "useGuildMemberAndUserPendingAvatarDecoration"
                )
              );

              //Avatar decoration customization section render module/function.
              if (this.decorationCustomizationSectionMod == undefined)
                this.decorationCustomizationSectionMod =
                  WebpackModules.getAllByProps("default").filter((obj) =>
                    obj.default
                      .toString()
                      .includes("useGuildMemberAndUserPendingAvatarDecoration")
                  )[0];
                ...
                (_, [args], ret) => {
                  ...
                  ret.props.children[0].props.children.push(
                    BdApi.React.createElement("button", {
                      ...
                      onClick: () => {
                        BdApi.showConfirmationModal(
                          "Change Avatar Decoration (YABDP4Nitro)",
                          BdApi.React.createElement(DecorModal)
                        );
                      },
                    })
                  );

                  let listOfDecorationIds = Object.keys(
                    BdApi.getData("YABDP4Nitro", "settings").avatarDecorations
                  );
                  ...
                  for (let i = 0; i < listOfDecorationIds.length; i++) {
                    ...
                    let encodedText = self.secondsightifyEncodeOnly(
                      "/a" + listOfDecorationIds[i]
                    ); // /a[id]
                    ...
                    let child = BdApi.React.createElement("img", {
                      ...
                      src:
                        ...
                        this.settings.avatarDecorations[
                          listOfDecorationIds[i]
                        ] +
                        ".png?size=64",
                    });
            ...
            async UploadEmote(url, channelIdLmao, msg, emoji, runs) {
              if (this.Uploader == undefined)
                this.Uploader = WebpackModules.getByProps(
                  "uploadFiles",
                  "upload"
                );
              ...
              let file = await fetch(url)
                .then((r) => r.blob())
                .then(
                  (blobFile) => new File([blobFile], emoji.name + extension)
                );
              file.platform = 1; // Not exactly sure what this does, but it should be set to 1.
              file.spoiler = false; //not marked as spoiler.

              if (this.CloudUploader == undefined)
                this.CloudUploader = WebpackModules.getByProps(
                  "CloudUpload",
                  "CloudUploadStatus"
                );

              //Start file upload
              let fileUp = new this.CloudUploader.CloudUpload(
                { file: file, isClip: false, isThumbnail: false, platform: 1 },
                channelIdLmao,
                false,
                0
              );
              ...
              if (this.settings.emojiBypassForValidEmoji) {
                if (
                  (DiscordModules.SelectedGuildStore.getLastSelectedGuildId() ==
                    emoji.guildId &&
                    !emoji.animated &&
                    (DiscordModules.ChannelStore.getChannel(
            ...
            customVideoSettings() {
              ...
              if (this.StreamButtons == undefined)
                this.StreamButtons = WebpackModules.getByProps(
              ...
              if (
                ...
                delete this.StreamButtons.ApplicationStreamResolutions
                  .RESOLUTION_1440;
                //Change 1440p resolution internally to custom resolution
                this.StreamButtons.ApplicationStreamResolutions.RESOLUTION_1440 =
                  this.settings.CustomResolution;

                //********************************** Requirements below this point*************************************
                this.StreamButtons.ApplicationStreamSettingRequirements[4].resolution =
                  this.settings.CustomResolution;
                this.StreamButtons.ApplicationStreamSettingRequirements[5].resolution =
                  this.settings.CustomResolution;
                this.StreamButtons.ApplicationStreamSettingRequirements[6].resolution =
                  this.settings.CustomResolution;

                //************************************Buttons below this point*****************************************
                //Set resolution button value to custom resolution
                this.StreamButtons.ApplicationStreamResolutionButtons[2].value =
                  this.settings.CustomResolution;
                delete this.StreamButtons.ApplicationStreamResolutionButtons[2]
                  .label;
                ...
                this.StreamButtons.ApplicationStreamResolutionButtons[2].label =
                  this.settings.CustomResolution.toString();

                //Set value of button with suffix label to custom resolution
                this.StreamButtons.ApplicationStreamResolutionButtonsWithSuffixLabel[3].value =
                  this.settings.CustomResolution;
                delete this.StreamButtons
                ...
                this.StreamButtons.ApplicationStreamResolutionButtonsWithSuffixLabel[3].label =
              ...
              this.StreamButtons.ApplicationStreamSettingRequirements.forEach(
                removeQualityParameters
              );
              function replace60FPSRequirements(x) {
                if (x.fps != 30 && x.fps != 15 && x.fps != 5)
                  x.fps = BdApi.getData("YABDP4Nitro", "settings").CustomFPS;
              }
              ...
              if (this.settings.CustomFPSEnabled && this.CustomFPS != 60) {
                ...
                this.StreamButtons.ApplicationStreamSettingRequirements.forEach(
                  replace60FPSRequirements
                );
                //set suffix label button value to the custom number
                this.StreamButtons.ApplicationStreamFPSButtonsWithSuffixLabel[2].value =
                  this.settings.CustomFPS;
                delete this.StreamButtons
                  .ApplicationStreamFPSButtonsWithSuffixLabel[2].label;
                ...
                this.StreamButtons.ApplicationStreamFPSButtonsWithSuffixLabel[2].label =
                  this.settings.CustomFPS + " FPS";
                //set fps button value to the correct number.
                this.StreamButtons.ApplicationStreamFPSButtons[2].value =
                  this.settings.CustomFPS;
                ...
                this.StreamButtons.ApplicationStreamFPSButtons[2].label =
                  this.settings.CustomFPS;
                this.StreamButtons.ApplicationStreamFPS.FPS_60 =
                  this.settings.CustomFPS;
              }
                ...
                BdApi.Patcher.instead(
                  ...
                  (_, msg, send) => {
                    ...
                    msg[1].validNonShortcutEmojis.forEach((emoji) => {
                      ...
                      if (
                        msg[1].content.includes(
                          "\\<" +
                            emoji.allNamesString.replace(/~\b\d+\b/g, "") +
                            emoji.id +
                            ">"
                        )
                      ) {
                        //remove the backslash
                        msg[1].content = msg[1].content.replace(
                          "\\<" +
                            emoji.allNamesString.replace(/~\b\d+\b/g, "") +
                            emoji.id +
                            ">",
                      ...
                      emoji.url =
                        emoji.url.split("?")[0] +
                        `?size=${this.settings.emojiSize}&quality=lossless`;
                      ...
                      if (msg.content.includes(ghostmodetext)) {
                        ...
                        (msg.content = msg.content.replace(
                          ...
                          (msg.content +=
                            " " +
                            emoji.url.split("?")[0] +
                            `?size=${this.settings.emojiSize}&quality=lossless&${emojiGhostIteration} `);
                        return;
                      }
            ...
            updateQuick() {
              ...
              settings.CustomResolution = parseInt(
                document.getElementById("qualityInput").value
              );
              parseInt(document.getElementById("qualityInputFPS").value);
              settings.CustomFPS = parseInt(
                document.getElementById("qualityInputFPS").value
              );
              if (
                parseInt(document.getElementById("qualityInputFPS").value) == 15
              )
                settings.CustomFPS = 16;
              if (
                parseInt(document.getElementById("qualityInputFPS").value) == 30
              )
                settings.CustomFPS = 31;
              if (
                parseInt(document.getElementById("qualityInputFPS").value) == 5
              )
                settings.CustomFPS = 6;
              const StreamButtons = WebpackModules.getByProps(
                "ApplicationStreamFPSButtons",
                "ApplicationStreamResolutionButtons"
              );
              if (
                settings.ResolutionEnabled &&
                settings.CustomResolution != 0
              ) {
                delete StreamButtons.ApplicationStreamResolutions
                  .RESOLUTION_1440;
                StreamButtons.ApplicationStreamResolutions.RESOLUTION_1440 =
                  settings.CustomResolution;
                StreamButtons.ApplicationStreamSettingRequirements[4].resolution =
                  settings.CustomResolution;
                StreamButtons.ApplicationStreamSettingRequirements[5].resolution =
                  settings.CustomResolution;
                StreamButtons.ApplicationStreamSettingRequirements[6].resolution =
                  settings.CustomResolution;
                StreamButtons.ApplicationStreamResolutionButtons[2].value =
                  settings.CustomResolution;
                delete StreamButtons.ApplicationStreamResolutionButtons[2]
                  .label;
                StreamButtons.ApplicationStreamResolutionButtons[2].label =
                  settings.CustomResolution.toString();
              ...
              if (settings.CustomFPSEnabled) {
                if (this.CustomFPS != 60) {
                  ...
                  delete StreamButtons
                    .ApplicationStreamFPSButtonsWithSuffixLabel[2].label;
                  StreamButtons.ApplicationStreamFPSButtonsWithSuffixLabel[2].label =
            ...
            videoQualityModule() {
              ...
              if (this.videoOptionFunctions == undefined)
                this.videoOptionFunctions =
                ...
                BdApi.Patcher.before(
                  ...
                  (e) => {
                    if (this.settings.minBitrate > 0) {
                      //Minimum Bitrate
                      e.framerateReducer.sinkWants.qualityOverwrite.bitrateMin =
                        this.settings.minBitrate * 1000;
                      e.videoQualityManager.qualityOverwrite.bitrateMin =
                        this.settings.minBitrate * 1000;
                      e.videoQualityManager.options.videoBitrateFloor =
                        this.settings.minBitrate * 1000;
                      e.videoQualityManager.options.videoBitrate.min =
                        this.settings.minBitrate * 1000;
                      e.videoQualityManager.options.desktopBitrate.min =
                        this.settings.minBitrate * 1000;
                    }

                    if (this.settings.maxBitrate > 0) {
                      //Maximum Bitrate
                      e.framerateReducer.sinkWants.qualityOverwrite.bitrateMax =
                        this.settings.maxBitrate * 1000;
                      e.videoQualityManager.qualityOverwrite.bitrateMax =
                        this.settings.maxBitrate * 1000;
                      e.videoQualityManager.options.videoBitrate.max =
                        this.settings.maxBitrate * 1000;
                      e.videoQualityManager.options.desktopBitrate.max =
                        this.settings.maxBitrate * 1000;
                    }

                    if (this.settings.targetBitrate > 0) {
                      //Target Bitrate
                      e.framerateReducer.sinkWants.qualityOverwrite.bitrateTarget =
                        this.settings.targetBitrate * 1000;
                      e.videoQualityManager.qualityOverwrite.bitrateTarget =
                        this.settings.targetBitrate * 1000;
                      e.videoQualityManager.options.desktopBitrate.target =
                        this.settings.targetBitrate * 1000;
                    }
              ...
              if (this.settings.CustomFPSEnabled) {
                BdApi.Patcher.before(
                  ...
                  (e) => {
                    ...
                    e.videoQualityManager.options.videoBudget.framerate =
                      this.settings.CustomFPS;
                    e.videoQualityManager.options.videoCapture.framerate =
                      this.settings.CustomFPS;

                    for (const ladder in e.videoQualityManager.ladder.ladder) {
                      e.videoQualityManager.ladder.ladder[ladder].framerate =
                        this.settings.CustomFPS;
                      //e.videoQualityManager.ladder.ladder[ladder].mutedFramerate = parseInt(this.settings.CustomFPS / 2);
                    }

                    for (const ladder of e.videoQualityManager.ladder
                      .orderedLadder) {
                      ladder.framerate = this.settings.CustomFPS;
                      //ladder.mutedFramerate = parseInt(this.settings.CustomFPS / 2);
                    }

                    e.videoQualityManager.connection.remoteVideoSinkWants =
                      this.settings.CustomFPS;
                  }
                );
              }
              ...
              if (this.settings.screenSharing) {
                BdApi.Patcher.before(
                  ...
                  (e) => {
                    ...
                    e.videoQualityManager.ladder.pixelBudget =
                      videoQuality.height * videoQuality.width;

                    //What follows is the word 'ladder' repeated way too many times.
                    for (const ladder in e.videoQualityManager.ladder.ladder) {
                      e.videoQualityManager.ladder.ladder[ladder].width =
                        videoQuality.width * (ladder / 100);
                      e.videoQualityManager.ladder.ladder[ladder].height =
                        videoQuality.height * (ladder / 100);
                    }
                    for (const ladder of e.videoQualityManager.ladder
                      .orderedLadder) {
                      ladder.width =
                        videoQuality.width * (ladder.wantValue / 100);
                      ladder.height =
                        videoQuality.height * (ladder.wantValue / 100);
            ...
            buttonCreate() {
              ...
              qualityButton.innerHTML =
                '<p style="display: block-inline; margin-left: -6%; margin-top: -4.5%;">Quality</p>';
              ...
              try {
                document
                  .getElementsByClassName(
                    DiscordClassModules.AccountDetails.container
                  )[0]
                  .appendChild(qualityButton);
              } catch (err) {
                console.log(
                  "YABDP4Nitro: What the fuck happened..? During buttonCreate()"
                );
                console.error(err);
              }
            ...
            async stickerSending() {
              if (this.currentChannelIdMod == undefined)
                this.currentChannelIdMod = WebpackModules.getByProps(
                  "getLastChannelFollowingDestination"
                );
              if (this.stickerSendabilityModule == undefined)
                this.stickerSendabilityModule = WebpackModules.getByProps(
                  "StickerSendability",
                  "getStickerSendability",
                  "isSendableSticker"
                );
              ...
              BdApi.Patcher.instead(
                ...
                (_, b) => {
                  ...
                  let stickerURL =
                    ...
                    stickerID +
                    ".png?size=4096&quality=lossless";
                  let currentChannelId =
                    this.currentChannelIdMod.getChannelId();
                  ...
                  if (!this.settings.uploadStickers) {
                    ...
                    DiscordModules.MessageActions.sendMessage(
                      currentChannelId,
                      messageContent,
                      undefined,
                      {}
            ...
            decodeAndApplyProfileColors() {
              BdApi.Patcher.after(
                ...
                (_, args, ret) => {
                  ...
                  let parsed = [...colorString[0]]
                    .map((c) =>
                      String.fromCodePoint(c.codePointAt(0) - 0xe0000)
                    )
                    .join("");
                  let colors = parsed
            ...
            async encodeProfileColors(primary, accent) {
              ...
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byProps("getTryItOutThemeColors")
              );

              //wait for color picker renderer module to be loaded
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byStrings(
                  "__invalid_profileThemesSection"
                )
              );

              if (this.colorPickerRendererMod == undefined)
                this.colorPickerRendererMod = WebpackModules.getAllByProps(
                  "default"
                ).filter((obj) =>
                  obj.default
                    .toString()
                    .includes("__invalid_profileThemesSection")
                )[0];

              BdApi.Patcher.after(
                "YABDP4Nitro",
                this.colorPickerRendererMod,
                "default",
                (_, args, ret) => {
                  ret.props.children.props.children.push(
                    ...
                    BdApi.React.createElement("button", {
                      ...
                      onClick: () => {
                        ...
                        try {
                          themeColors = ZLibrary.WebpackModules.getByProps(
                            "getTryItOutThemeColors"
                          ).getAllTryItOut().tryItOutThemeColors;
                        } catch (err) {
                          console.warn(err);
                        }
                        if (themeColors == null) {
                          try {
                            themeColors = ZLibrary.WebpackModules.getByProps(
                              "getTryItOutThemeColors"
                            ).getAllPending().pendingThemeColors;
                          } catch (err) {
                            console.error(err);
                          }
                        }
                        if (themeColors == undefined) {
                          Toasts.warning(
                            "Nothing has been copied. Is the selected color identical to your current color?"
                          );
                          return;
                        }
            ...
            bannerUrlDecoding() {
              ...
              if (this.bannerUrlModule == undefined)
                this.bannerUrlModule =
                  WebpackModules.getByPrototypes("getBannerURL");
              ...
              BdApi.Patcher.instead(
                "YABDP4Nitro",
                this.bannerUrlModule.prototype,
                "getBannerURL",
                (user, [args], ogFunction) => {
                  ...
                  if (!this.badgeUserIDs.includes(user.userId))
                    this.badgeUserIDs.push(user.userId);
              ...
              if (this.profileRenderer == undefined)
                this.profileRenderer = WebpackModules.getAllByProps(
                  "default"
                ).filter((obj) =>
                  obj.default.toString().includes("PRESS_PREMIUM_UPSELL")
                )[0];
            ...
            async bannerUrlEncoding(secondsightifyEncodeOnly) {
              ...
              await BdApi.Webpack.waitForModule(
                BdApi.Webpack.Filters.byStrings("USER_SETTINGS_PROFILE_BANNER")
              );
              if (this.profileBannerSectionRenderer == undefined)
                this.profileBannerSectionRenderer =
                  WebpackModules.getAllByProps("default").filter((obj) =>
                    obj.default
                      .toString()
                      .includes("USER_SETTINGS_PROFILE_BANNER")
                  )[0];
                  ...
                  ret.props.children.props.children.push(
                    ...
                    BdApi.React.createElement("button", {
                      ...
                      onClick: async function () {
                        ...
                        let profileBannerUrlInputValue = String(
                          document.getElementById("profileBannerUrlInput").value
                        );
            ...
            bannerUrlDecodingPreview() {
              if (this.profileCustomizationModule == undefined)
                this.profileCustomizationModule = WebpackModules.getByProps(
                  "getTryItOutThemeColors"
                );
              BdApi.Patcher.after(
                "YABDP4Nitro",
                this.profileCustomizationModule,
                "getAllPending",
                (_, args, ret) => {
                  ...
                  if (
                    ...
                    !String(matchedText).endsWith(".jpeg") &&
                    !String(matchedText).endsWith(".webp") &&
                    !String(matchedText).endsWith(".mp4") &&
                    !String(matchedText).endsWith(".tiff") &&
                    !String(matchedText).endsWith(".avi") &&
                    !String(matchedText).endsWith(".webm")
                  ) {
            ...
            appIcons() {
              ...
              if (this.appIconModule == undefined)
                this.appIconModule = WebpackModules.getByProps(
              ...
              if (this.appIconButtonsModule == undefined)
                this.appIconButtonsModule = WebpackModules.getAllByProps(
                  "default"
                ).filter((obj) =>
                  obj.default.toString().includes("renderCTAButtons")
                )[0];
              BdApi.Patcher.before(
                "YABDP4Nitro",
                this.appIconButtonsModule,
                "default",
                (_, args) => {
            ...
            onStart() {
              ...
              this.currentUser =
                WebpackModules.getByProps("getCurrentUser").getCurrentUser();
              this.originalNitroStatus = this.currentUser.premiumType;
              this.previewInitial = BdApi.Webpack.getModule(
                BdApi.Webpack.Filters.byProps("isPreview")
              ).isPreview;
              this.userBgs = {};
              ...
              this.buttonClassModule = WebpackModules.getByProps(
                "lookFilled",
                "button",
                "contents"
              );
              this.dispatcher = WebpackModules.getByProps(
                "subscribe",
                "dispatch"
              );
              this.saveAndUpdate();
            ...
            onStop() {
              ...
              if (document.getElementById("qualityInput"))
                document.getElementById("qualityInput").remove();
              if (document.getElementById("copy3y3button"))
                document.getElementById("copy3y3button").remove();
              if (document.getElementById("profileBannerButton"))
                document.getElementById("profileBannerButton").remove();
              if (document.getElementById("profileBannerUrlInput"))
                document.getElementById("profileBannerUrlInput").remove();
              if (document.getElementById("decorationButton"))
                document.getElementById("decorationButton").remove();
              if (document.getElementById("changeProfileEffectButton"))
                document.getElementById("changeProfileEffectButton").remove();
              if (document.getElementById("profilePictureUrlInput"))
                document.getElementById("profilePictureUrlInput").remove();
              if (document.getElementById("profilePictureButton"))
                document.getElementById("profilePictureButton").remove();
              BdApi.DOM.removeStyle("YABDP4Nitro");
